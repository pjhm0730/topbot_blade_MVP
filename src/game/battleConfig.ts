export const BATTLE_CONFIG = {
  ...
  maxBattleDurationMs: 20000,
  preEliminationEnergyFloorRatio: 0.07,

  // 시간대별 충돌 데미지. 초반은 화려하게 부딪히지만 에너지는 천천히 깎입니다.
  earlyPhaseDamageMultiplier: 0.9,
  midPhaseDamageMultiplier: 1.4,
  latePhaseDamageMultiplier: 1.6,
  ...
  centerAttractionStrength: 125,
  targetSeekingStrength: 82,
  randomSteeringStrength: 36,
  boundaryCorrectionStrength: 78,
  battleStartBoost: 1.45,
  ...
  // 현재 마지막 생존 후보와 최종 음료수 담당 시각 하이라이트.
  loserCandidateHighlightEnabled: true,
  loserCandidateStartDelayMs: 3000,
  loserCandidateEnergyRatioThreshold: 0.5,
  loserCandidateRingColor: 0x2dd4bf,
  loserCandidateGlowColor: 0xffd166,
  finalLoserRingColor: 0xffd166,
  finalLoserGlowColor: 0x7df9ff,
  loserCandidatePulseSpeed: 0.008,
  loserCandidateHighlightDepth: 38,
  finalLoserHighlightDepth: 46,

  leaderboardDepth: 86,
  leaderboardMinWidth: 148,
  leaderboardMaxWidth: 220,
  leaderboardRowHeight: 23,
} as const;
